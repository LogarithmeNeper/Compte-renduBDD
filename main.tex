...
%TODO
%Efficacité de notre fragmentation
%Eviter de répéter ce qui a été dit au dessus
\subsubsection{Bilan}
<<<<<<< HEAD
=======
%Insérer schéma global (cf. Charles?) -> écrire l'ensemble des tables de chaque base plutôt: EuropeDuNord = Clients_EU_N + Clients_AUTRE + ..., etc
